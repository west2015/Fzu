...
public class CourseService {
	...
	public String getCourseTableFromNet(UserEntity user,String xn,String xq){
		JSONArray jsonArr = new JSONArray();
//		String url="http://59.77.226.33/xszy/wsxk/wdkb/kb_xs.asp?menu_no=&xh=221300410&xn=2014&xq=02";
